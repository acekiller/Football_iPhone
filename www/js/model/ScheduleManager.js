...
var SCHEDULE_TRADITIONAL_AWAYTEAM_NAME = 3;
...
ScheduleManager.prototype = {
	...
	readData: function(inputString){
		...
		for (var i = 0; i < len; i++) {
			...
			var obj = new ScheduleObject(record[SCHEDULE_PLAYING_TIME], record[SCHEDULE_SIMPLIFIED_HOMETEAM_NAME], 
				record[SCHEDULE_SIMPLIFIED_HOMETEAM_NAME], record[SCHEDULE_TRADITIONAL_AWAYTEAM_NAME], 
